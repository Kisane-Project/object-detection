...
if __name__=='__main__':
    ...
    save_dir = '../../dataset/kisane_DB/multi_augmentation'
    get_random_augmentation(base_dir='../../dataset/kisane_DB', view='right', overlap_cri=0.2, num_target_samples=50000, num_max_objects=6, save_dir=save_dir)
    get_random_augmentation(base_dir='../../dataset/kisane_DB', view='top', overlap_cri=0.2, num_target_samples=50000, num_max_objects=6, save_dir=save_dir)
    get_random_augmentation(base_dir='../../dataset/kisane_DB', view='left', overlap_cri=0.2, num_target_samples=50000, num_max_objects=6, save_dir=save_dir)