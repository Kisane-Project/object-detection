...
if __name__=='__main__':
    ...
    save_dir = '../../dataset/kisane_DB/single_patch'
    
    right_image_list = glob('../../dataset/kisane_DB/single_data/*/*/*/TP5/*/*_R2_*_Color.png')
    top_image_list = glob('../../dataset/kisane_DB/single_data/*/*/*/TP5/*/*_T2_*_Color.png')
    left_image_list = glob('../../dataset/kisane_DB/single_data/*/*/*/TP5/*/*_L2_*_Color.png')
